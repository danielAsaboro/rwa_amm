      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto">
            Advanced trading platform for real-world assets. Experience
            seamless trading with institutional-grade funding and security.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/trade" className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-purple-600 hover:to-pink-600 transition-all flex items-center justify-center">
              Start Trading
              <ArrowUpRight className="ml-2 w-5 h-5" />
            </a>
            <a href="/create-mint" className="border border-white/20 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-white/10 transition-all text-center">
              Create Asset
            </a>
            <a href="/create-pool" className="border border-white/20 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-white/10 transition-all text-center">
              Create Trading Pool
            </a>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all">
              ...
              <a href="/trade" className="w-full mt-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white py-2 rounded-lg font-medium hover:from-purple-600 hover:to-pink-600 transition-all block text-center">
                Trade
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-400">
                Advanced security protocols and multi-signature governance
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">
                Access to institutional-grade funding pools with minimal
                price changes and optimal pricing.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-400">
                Comprehensive analytics and real-time data to make informed
                trading decisions.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Advanced Automated Market Maker for real-world assets on Solana.
              </p>
            </div>
            <div>
