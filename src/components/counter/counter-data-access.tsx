...
// import { getCpAmmProgram, getCpAmmProgramId } from '@project/anchor'
...
//   const programId = useMemo(() => getCpAmmProgramId(cluster.network as Cluster), [cluster])
//   const program = useMemo(() => getCpAmmProgram(provider, programId), [provider, programId])
