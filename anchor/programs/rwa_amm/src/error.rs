...
pub enum PoolError {
    ...
    // RWA Transfer Hook Errors
    #[msg("User not eligible for trading")]
    UserNotEligible,

    #[msg("User KYC has expired")]
    KYCExpired,
    ...
    #[msg("Daily trading limit exceeded")]
    DailyLimitExceeded,

    #[msg("Monthly trading limit exceeded")]
    MonthlyLimitExceeded,

    #[msg("Geographic restrictions apply")]
    GeographicRestriction,

    #[msg("Trading outside allowed hours")]
    TradingHoursViolation,
