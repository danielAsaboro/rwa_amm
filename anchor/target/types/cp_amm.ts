 ...
 */
export type CpAmm = {
  "address": "574KpKhRZRWi9etrtmRSXZof7JASoPxU6ZUiFgLVErRv",
  "metadata": {
    "name": "cpAmm",
    "version": "0.1.3",
    "spec": "0.1.0",
  ...
  "instructions": [
    ...
    },
    {
      ...
      "accounts": [
        {
          "name": "poolAuthority",
          "address": "ASvcY1ZnHZggVdAEWQ7fKTkaqJz2fqBdeK8xSdJtwDCe"
        },
        {
          "name": "pool",
          "writable": true
    ...
    {
      "name": "updateHookRegistryAuthority",
      "docs": [
  ...
  "errors": [
    ...
    {
      "code": 6048,
      "name": "failedToDeserializeAccount",
    ...
    {
      "code": 6059,
      "name": "unauthorizedHookProgram",
      "msg": "Hook program not whitelisted"
    },
    {
      "code": 6060,
      "name": "hookAccountResolutionFailed",
    ...
    {
      "code": 6062,
      "name": "invalidHookRegistry",
      "msg": "Invalid hook registry"
    },
    {
      "code": 6063,
      "name": "hookRegistryFull",
      "msg": "Hook registry full"
    },
    {
      "code": 6064,
      "name": "hookProgramAlreadyWhitelisted",
      "msg": "Hook program already whitelisted"
    },
    {
      "code": 6065,
      "name": "hookProgramNotFound",
